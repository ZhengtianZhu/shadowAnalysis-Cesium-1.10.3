<template>
    ...
    <div class="sm-function-module-sub-section" v-stopdrag style="margin:0">
      ...
      <div class="boxchild flex-between" style="padding:0">
        ...
        <div class="flex flex-end" style="width:auto">
          <button @click="analysis" class="tbtn tbtn-width" type="button" style:true>{{Resource.analyze}}</button>
          <button
            @click="clear"
  ...
  <div class="legend" v-show="legendShow">
    <img src="public/img/other/legend_shadow.png" alt:true /><!-- alt might be other type,alt:true -->
  </div>
</template>
...
export default {
  ...
  //I have not defined this two functions, yet.
const props = defineProps<{

/*   formatTooltip2(val:string) : Function ,//I have not used it, yet
  formatTooltip3(val:string) : Function */
 ...
 /*  methods: {
  ...
  //Zhengtian thinks it is return those variables
  let {
    marks,
    timeValue, //开始结束时间
    currentDate, //当前日期
